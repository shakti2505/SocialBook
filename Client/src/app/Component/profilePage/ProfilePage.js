...
const ProfilePage = () => {
  ...
  const handleProfilePictuePreview = (e) => {
    ...
    setProfilePicturePreview((prevPreviews) => [...prevPreviews, ...imagePreviewUrls]);
  }
  ...
  const changeProfilePicture = async () => {
    try {
      ...
      const response2 = await axios.put(BASE_URL_API + apiVariables.uploadDP.url, {
        profilePic: imageURL,
  ...
  const UpdateUserInfo = async () => {
    setisloading(true)
    let apicall = await axios.put(BASE_URL_API + apiVariables.uploadDP.url, {
      bio: bio,
    }, { withCredentials: "include" });
    ...
    <>
        ...
        <div className="container">
          ...
          <section className="">
            <div
              ...
              style={{ backgroundImage: `url(${url2})`, height: '400px', backgroundSize: 'cover', backgroundPosition: 'center', marginLeft: "10%", marginRight: "10%" }}
            >
            </div>
            <div className="d-flex justify-content-evenly userProfile" onClick={() => setAddprofilePictureModal(true)}>
              <img src={loggedInUser.profilePic} style={{ width: "10rem", height: "10rem", borderRadius: "50%", objectFit: "cover", marginTop: '-100px' }} className=" shadow-3-strong align-items-center position-relative" />
            </div>
          ...
          <section className="text-center">
            <div className="d-flex flex-column text-center justify-content-center">
              <h2><strong>{loggedInUser.firstName} {loggedInUser.LastName}</strong></h2>
                        ...
                        <div className="container ">
                          <div className="row">
                            <div className="col-md-5 mb-4">
                              <div className="card">
                                <div className="card-body">
                                  <h5 className="card-title"><strong>Intro</strong></h5>
                                  {
                                    addBio
                                      ?
                                      <>
                                        {/* <input type="text" className="w-100" name="bio" onChange={(e)=>setBio(e.target.value)}/> */}
                                        <textarea disabled={isloading ? true : false} className="form-control w-100" rows="3" type="text" value={bio} onChange={handleChangeBio} placeholder="Describle Who you are"></textarea>
                                        <p className="text-muted float-end mt-1" >{101 - bio.length} Character remaining</p>
                                        <div className="d-flex justify-content-between mt-5">
                                          <div className="d-flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width='20' height="20"><path d="M57.7 193l9.4 16.4c8.3 14.5 21.9 25.2 38 29.8L163 255.7c17.2 4.9 29 20.6 29 38.5v39.9c0 11 6.2 21 16 25.9s16 14.9 16 25.9v39c0 15.6 14.9 26.9 29.9 22.6c16.1-4.6 28.6-17.5 32.7-33.8l2.8-11.2c4.2-16.9 15.2-31.4 30.3-40l8.1-4.6c15-8.5 24.2-24.5 24.2-41.7v-8.3c0-12.7-5.1-24.9-14.1-33.9l-3.9-3.9c-9-9-21.2-14.1-33.9-14.1H257c-11.1 0-22.1-2.9-31.8-8.4l-34.5-19.7c-4.3-2.5-7.6-6.5-9.2-11.2c-3.2-9.6 1.1-20 10.2-24.5l5.9-3c6.6-3.3 14.3-3.9 21.3-1.5l23.2 7.7c8.2 2.7 17.2-.4 21.9-7.5c4.7-7 4.2-16.3-1.2-22.8l-13.6-16.3c-10-12-9.9-29.5 .3-41.3l15.7-18.3c8.8-10.3 10.2-25 3.5-36.7l-2.4-4.2c-3.5-.2-6.9-.3-10.4-.3C163.1 48 84.4 108.9 57.7 193zM464 256c0-36.8-9.6-71.4-26.4-101.5L412 164.8c-15.7 6.3-23.8 23.8-18.5 39.8l16.9 50.7c3.5 10.4 12 18.3 22.6 20.9l29.1 7.3c1.2-9 1.8-18.2 1.8-27.5zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z" /></svg>
                                            <p className="text-muted mx-2">Public</p>
                                          </div>
                                          <div>
                                            <button disabled={isloading ? true : false} className="btn btn-light btn-md mx-2 shadow-sm" onClick={() => setAddBio(false)}>Cancel</button>
                                            <button onClick={UpdateUserInfo} disabled={isloading ? true : false} className="btn btn-light btn-md shadow-sm">Save</button>
                                          </div>
                                        </div>
                                      </>
                                      :
                                      <button placeholder="dfd" onClick={addbio} className="btn btn-light btn-lg w-100 mt-1 shadow-sm">{loggedInUser.bio ? "Edit Bio" : "Add bio"} </button>

                                  }
                                  <ul className="list-unstyled text-muted">
                                    <li className="mt-3">
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" width="25" height="25"><path fill="#8C939D" d="M543.8 287.6c17 0 32-14 32-32.1c1-9-3-17-11-24L512 185V64c0-17.7-14.3-32-32-32H448c-17.7 0-32 14.3-32 32v36.7L309.5 7c-6-5-14-7-21-7s-15 1-22 8L10 231.5c-7 7-10 15-10 24c0 18 14 32.1 32 32.1h32v69.7c-.1 .9-.1 1.8-.1 2.8V472c0 22.1 17.9 40 40 40h16c1.2 0 2.4-.1 3.6-.2c1.5 .1 3 .2 4.5 .2H160h24c22.1 0 40-17.9 40-40V448 384c0-17.7 14.3-32 32-32h64c17.7 0 32 14.3 32 32v64 24c0 22.1 17.9 40 40 40h24 32.5c1.4 0 2.8 0 4.2-.1c1.1 .1 2.2 .1 3.3 .1h16c22.1 0 40-17.9 40-40V455.8c.3-2.6 .5-5.3 .5-8.1l-.7-160.2h32z" /></svg>
                                      <span className="mx-3">Lives in <strong> {loggedInUser.livesIn}, {loggedInUser.city}</strong></span>
                                    </li>
                                    <li className="mt-3">
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20"><path fill="#8C939D" d="M47.6 300.4L228.3 469.1c7.5 7 17.4 10.9 27.7 10.9s20.2-3.9 27.7-10.9L464.4 300.4c30.4-28.3 47.6-68 47.6-109.5v-5.8c0-69.9-50.5-129.5-119.4-141C347 36.5 300.6 51.4 268 84L256 96 244 84c-32.6-32.6-79-47.5-124.6-39.9C50.5 55.6 0 115.2 0 185.1v5.8c0 41.5 17.2 81.2 47.6 109.5z" /></svg>
                                      <span className="mx-3">Single</span>

                                    </li>
                                    <li className="mt-3">
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="20" height="20"><path fill="#8C939D" d="M256 0a256 256 0 1 1 0 512A256 256 0 1 1 256 0zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" /></svg>
                                      <span className="mx-3">Joined on <strong>December 2011</strong></span>

                                    </li>
                                    <li className="mt-3">
                                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="25" height="25"><path fill="#8C939D" d="M323.4 85.2l-96.8 78.4c-16.1 13-19.2 36.4-7 53.1c12.9 17.8 38 21.3 55.3 7.8l99.3-77.2c7-5.4 17-4.2 22.5 2.8s4.2 17-2.8 22.5l-20.9 16.2L512 316.8V128h-.7l-3.9-2.5L434.8 79c-15.3-9.8-33.2-15-51.4-15c-21.8 0-43 7.5-60 21.2zm22.8 124.4l-51.7 40.2C263 274.4 217.3 268 193.7 235.6c-22.2-30.5-16.6-73.1 12.7-96.8l83.2-67.3c-11.6-4.9-24.1-7.4-36.8-7.4C234 64 215.7 69.6 200 80l-72 48V352h28.2l91.4 83.4c19.6 17.9 49.9 16.5 67.8-3.1c5.5-6.1 9.2-13.2 11.1-20.6l17 15.6c19.5 17.9 49.9 16.6 67.8-2.9c4.5-4.9 7.8-10.6 9.9-16.5c19.4 13 45.8 10.3 62.1-7.5c17.9-19.5 16.6-49.9-2.9-67.8l-134.2-123zM16 128c-8.8 0-16 7.2-16 16V352c0 17.7 14.3 32 32 32H64c17.7 0 32-14.3 32-32V128H16zM48 320a16 16 0 1 1 0 32 16 16 0 1 1 0-32zM544 128V352c0 17.7 14.3 32 32 32h32c17.7 0 32-14.3 32-32V144c0-8.8-7.2-16-16-16H544zm32 208a16 16 0 1 1 32 0 16 16 0 1 1 -32 0z" /></svg>
                                      <span className="mx-3">Followed by <strong>83 people</strong></span>

                                    </li>
                                  </ul>
                                  <button type="button" className="btn btn-light w-100 shadow-sm mb-4">Edit Details</button>
                                  <button type="button" className="btn btn-light w-100 shadow-sm mb-4">Add Features</button>
                                </div>
                              ...
                              <div className="card mt-2">
                                <div className="card-body">
                                  ...
                                  <a href="" id="Photos" className="text-reset d-inline-block"><h5 className="card-title mt-1 mb-4"><strong>Photos</strong> </h5></a>
                                  <a href="" id="seeAllPhotos" className="btn btn-link d-inline-block float-right py-1 px-3 ">See All Photos</a>

                                  {
                                    postUrl.length !== 0 && postUrl.map((item, index) => {
                                      return (
                                        <>
                                          <div className="row gx-2">
                                            <div className="col-lg-4">
                                              <a href={index == 0 && item} target="_blank">
                                                <img src={index == 0 && item} className="w-100 shadow-1-strong rounded" alt="Image1" style={{ borderTopLeftRadius: "0.5rem" }} />
                                              </a>
                                            </div>
                                            <div className="col-lg-4">
                                              <img src={index == 1 && item} className="w-100 shadow-1-strong rounded" alt="Image2" />
                                            </div>
                                            <div className="col-lg-4">
                                              <img src={index == 2 && item} className="w-100 shadow-1-strong rounded" alt="Image3" style={{ borderTopRightRadius: "0.5rem" }} />
                                            </div>
                                          </div>
                                        </>
                                      )
                              ...
                              <div className="card mt-2">
                                <div className="card-body">
                                  ...
                                  <a href="" id="Photos" className="text-reset d-inline-block"><h5 className="card-title mt-1 mb-4"><strong>Friends <small className="text-muted ml-1">561</small></strong></h5></a>
                                  <a href="" id="seeAllPhotos" className="btn btn-link d-inline-block float-right py-1 px-3 ">See All Friends</a>
                                        ...
                                        <>
                                          <div className="row gx-2 text-center text-muted">
                                            <div className="col-lg-4">
                                              ...
                                              <p className="mb-1"><small id="friend-name">John Doe</small></p>
                            ...
                            <div className="col-md-7 mb-4 mb-md-0">
                              <div className='card'>
                                <div className='card-body'>
                                  <div className="d-flex justify-contern-between">
                                    <a href="/profile">
                                      <img src={loggedInUser.profilePic} alt='img' width='40' height='40' style={{ borderRadius: "50%", objectFit: "cover" }} />
                                    </a>

                                    <button onClick={OpenPostModal} className='searchBtn text-center btn btn-light mx-2 btn-block w-100'>
                                      {
                                ...
                                <div className='d-flex justify-content-around py-2 px-2'>
                                  ...
                                  <button onClick={OpenPostModal} type="button" className="btn btn-light  btn-sm  py-2 px-2 mx-2">
                                  ...
                                  <button type="button" className="btn btn-light  btn-sm  py-2 px-2 mx-2">
      ...
      >
        <div className="d-flex justify-content-between" >
          ...
          <button className="btn btn-light" onClick={() => setAddprofilePictureModal(false)}>X</button>
        </div>
        <hr></hr>
        <Modal.Body>
          ...
          <button className='btn btn-light w-100 position-relative ' id="profilePicUploadBtn" disabled={profilePicturePreview.length !== 0 ? true : false}
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width="20" height="20"><path fill="#0064D1" d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z" /></svg>
            <span style={{ color: "#0064D1" }} className="mx-2 mt-1">Uplaod Photo</span>

            <input
              id='FileUpload'
              style={{ zIndex: "1", opacity: "0", border: "1px solid", left: "1rem" }}
          ...
          <div className="d-flex justify-content-center align-items-center mt-2 position-relative">
            {
              profilePicturePreview.length !== 0 && profilePicturePreview.map((item) => {
                return (
                  <>
                    <img id="previewImg" src={item} style={{ width: "10rem", height: "10rem", borderRadius: '50%', objectFit: 'cover', alignItems: "center" }} />
                  </>
                )
              })
            }
        ...
        <Modal.Footer className={profilePicturePreview.length !== 0 ? '' : 'd-none'}>
          {/* <Button onClick={() => setAddprofilePictureModal(false)}>Close</Button> */}
          <Button onClick={handleShowCancleDpUplpad}>Close</Button>
          <Button onClick={changeProfilePicture} id="postbtn">Save</Button>
        </Modal.Footer>
      </Modal>
      {/* add profile picture modal */}

      <Modal show={ShowCancleDpUplpad} backdrop="static"
        keyboard={false} centered size="md"
      >
        <Modal.Header closeButton>
          <Modal.Title>Discard changes
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>Are you sure that you want to discard your changes?
        </Modal.Body>
        <Modal.Footer>
          <Button variant="secondary" onClick={() => setShowCancleDpUplpad(false)}>
            Close
          </Button>
