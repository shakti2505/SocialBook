    ...
    >
      <div className="call-card">
        ...
        <div className="call-name">
          <p className="call-p1 text-white">{name ? name : callerName}</p>
          <p className="call-p2 text-white">
            {receivingCall && !callAccepted && "Incoming video call "}
          </p>
          <p className="call-p2 text-white">
            {callAccepted && !callEnded && "Connected "}
          </p>
        </div>
