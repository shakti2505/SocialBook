        ...
        <>
            ...
            >
                  ...
                  <h5 className='mx-2 mt-2'>Create Post</h5>
                    <button className='btn btn-link mx-2 mt-2 rounded-sm  text-muted text-decoration-none' onClick={() => ClosePostModal()}>X</button>
                  </div>
                <Modal.Body style={{ maxHeight: '25rem', overflowY: "auto", position: 'relative' }}>
                    ...
                    <textarea onChange={(e) => setPostCaption(e.target.value)} placeholder={`What's on your Mind, ${loggedInUser.firstName}?`} className='w-100 mt-3' style={{ border: "0", outline: "none", fontSize: '25px', }} value={postCaption && postCaption}></textarea>
                    ...
                    <div
                        ...
                        <button className='btn btn-link mx-2 mt-2 rounded-sm  text-muted text-decoration-none' onClick={() => setShowAddPhotoModal(false)}>X</button>
                                    ...
                                    <>
                                        <div style={{ position: 'relative', width: "100%" }} >
                                            ...
                                            {imagePreviews.length > 3 && index === 2 && (
                                                <h1 style={{ position: 'absolute', bottom: '25%', left: '25%', color: 'white' }}>+{imagePreviews.length - 3}</h1>
                                            )}
                                        </div>
                                    </>
                                ))}
