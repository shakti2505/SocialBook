            ...
            <div className='card mt-2 shadow-sm'>
              <div className='card-body'>
                <div className="d-flex">
                  ...
                  <button onClick={OpenPostModal} className='searchBtn text-muted btn btn-light mx-2 w-100 d-flex justify-start items-center shadow-md'>
                    {
              ...
              <div className='d-flex justify-content-around align-items-center mb-2'>
                ...
                <button onClick={OpenPostModal} type="button" className="btn btn-light btn-md shadow-md d-flex justify-content-between align-items-center">
                ...
                <button type="button" className="btn btn-light btn-md d-flex justify-content-between shadow-md  align-items-center">
