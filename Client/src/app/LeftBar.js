    ...
    <>
      <div className="col-4  mt-3" id="left-container">
        <div>
          <div>
            <button
              className="btn btn-light w-100 d-flex justify-content-start align-items-center"
            ...
            >
              ...
              />
              <h6 className="mt-1 mx-3">
                {loggedInUser.firstName} {loggedInUser.LastName}
              </h6>
            </button>
          </div>
          <div className="mt-2">
            <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
              <svg
              ...
              <h6 className="mt-1 mx-3">Friends</h6>
            </button>
          </div>
          <div className="mt-2">
            <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
              ...
              <h6 className="mt-1 mx-3">Events</h6>
            </button>
          </div>
          <div className="mt-2">
            <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
              ...
              <h6 className="mt-1 mx-3">Feeds</h6>
            </button>
          </div>
          <div className="mt-2">
            <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
              ...
              <h6 className="mt-1 mx-3">Memories</h6>
            </button>
          </div>
          {/* Collapse starts */}
          <div>
            <div className="collapse hide" id="collapseExample">
              ...
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Messanger</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start  align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Ads Manager</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Blood Donation</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Climate science center</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Fundraiser</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Socialbook Pay</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Pages</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Market Place</h6>
                </button>
              </div>
              <div className="mt-2">
                <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
                  ...
                  <h6 className="mt-1 mx-3">Video</h6>
                </button>
              </div>
            </div>
            <div className="mt-2">
              <button
                ...
                className="btn btn-light d-flex justify-content-start align-items-center w-100"
          ...
          {/* Collapse ends */}
          <hr className="mx-3" />
          <h5 className="mx-3" style={{ color: "#65676B" }}>
            Your Shortcuts
          </h5>
          <div className="mt-2">
            <button className="btn btn-light w-100 d-flex justify-content-start align-items-center">
